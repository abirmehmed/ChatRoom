...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <div className="pt-[144px] flex h-[calc(100vh-144px)]"> {/* 144px = header height (72px) + groups section height (72px) */}
        {/* Fixed Members Sidebar with Scrollable Content */}
        <div className="w-64 bg-gray-800 fixed left-0 bottom-0 top-[144px] flex flex-col">
        ...
        {/* Scrollable Chat Area - Positioned next to fixed sidebar */}
